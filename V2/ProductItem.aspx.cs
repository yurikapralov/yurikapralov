...
public partial class V2_ProductItem : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Master.HeaderTitle  = lblProductName.Text;
            Master.MainTitle = lblProductName.Text;
            if (Request.UrlReferrer != null)
                PreviousPage = Request.UrlReferrer.OriginalString;
            else
                PreviousPage = "http://www.Stripshoes.ru";
        }
    ...
    {
        Response.Redirect("http://www.Stripshoes.ru/Shopping.aspx");
    }
