<%@ Page Title="" Language="C#" MasterPageFile="~/Theme2.master" AutoEventWireup="true" CodeFile="Shopping.aspx.cs" Inherits="Shopping" Theme="Theme2" %>
...
<asp:Panel ID="pnlShoppingCart" runat="server">
        ...
        <p class="conditions">Внимание: Ознакомтесь с <a href="javascript:window.open('deliverpopup.html','Deliver','top=0,left=0,width=800,height=780');void(0);" class="mainlink">условиями</a> доставки товара!</p>  
        ...
        <asp:Panel ID="pnlTotals" runat="server">
            ...
            <p><asp:Label runat="server" ID="lblUsa" Visible="False">Заказ содержит товары, доставляемые напрямую из США</asp:Label></p>
            <p>
                <asp:Button ID="btnUpdate" runat="server" Text="Обновить" CssClass="subform"
                    OnClick="btnUpdate_Click" />
                <asp:Button ID="btnOrder" runat="server" Text="Оформить заказ" CssClass="subform" Width="150px"
                    OnClick="btnOrder_Click" />
                <asp:Button ID="btnReset" runat="server" Text="Отменить заказ" CssClass="subform" Width="150px"
    ...
    <asp:Panel ID="pnlAuntification" runat="server" Visible="false" ClientIDMode="Static">
        <p>
            ...
            <p>Регистрация избавляет Вас от необходимости вводить каждый раз Ваши контактные данные, а также дает
            возможность отслеживать историю Ваших заказов.</p>
            <p>Регистрация на нашем сайте НЕ ЯВЛЯЕТСЯ обязательной.</p>
        <asp:Login ID="ctrLogin" FailureText="Неправильное имя или пароль" runat="server">
            <LayoutTemplate>
                <table width="100%">
                    <tr>
                        <td  align="right">
                            ...
                            <asp:TextBox ID="Password" runat="server" CssClass="textform" TextMode="Password" ToolTip="Пароль" ></asp:TextBox>
                ...
                <p></p>
                 <asp:Button ID="btnLogin" runat="server" Text="Войти" CssClass="subform" ValidationGroup="Login1"
                                CommandName="Login"/> 
            <asp:Button ID="btnEsc" runat="server" Text="Пропустить регистрацию" OnClick="btnEsc_Click" CssClass="subform" Width="180px" />
            </LayoutTemplate>
        </asp:Login>
    </asp:Panel>
    ...
    <tr class="tablebody">
    <td class="cont_table"><asp:Button ID="btnAdmit" runat="server" Text="Подтвердить" 
            CssClass="subform" onclick="btnAdmit_Click" OnClientClick="yaCounter11473630.reachGoal('ORDER'); return true;" /></td>
    ...
    <asp:Panel ID="pnlFinal" runat="server"  Visible="false">
        ...
        <p class="ProductItemDescription">В ближайшее время с Вами свяжется наш сотрудник.</p>
        <p align="center">
