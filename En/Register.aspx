<%@ Page Title="" Language="C#" MasterPageFile="~/En/Theme2En.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="En_Register" Theme="Theme2"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainPlaceHolder" Runat="Server">
    <asp:CreateUserWizard ID="CreateUserWizard1" runat="server"
     AutoGeneratePassword="false" ContinueDestinationPageUrl="~/Default.aspx"
      ...
      Onsendingmail="Createuserwizard1_SendingMail" CreateUserButtonText="Create User" FinishCompleteButtonText="Save">
