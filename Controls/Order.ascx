<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Order.ascx.cs" Inherits="Controls_Order" %>
<h2>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-condensed">
                        ...
                        <tr>
                            ...
                            <td>
                            <table class="table table-striped table-bordered table-condensed" style="width:100%;" cellpadding="0" cellpadding="0" border="0">
                            <tr>
                            <td>Артикул</td>
                            <td>Кол-во</td>
                            <td>Цена</td>
