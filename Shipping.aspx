...
<h2>Существуют 3 способа доставки: </h2>
    ...
    2а. курьером по Москве (только в пределах МКАД) (до 40-го  размера включительно)<br/>
    стоимость доставки - 300 рублей<br/>
    2б. курьером за пределами МКАД<br/>
    тариф доставки зависит от пункта назначения.<br/>
    ...
    Дополнительная информация по телефону:  (915) 246-60-88</p>
