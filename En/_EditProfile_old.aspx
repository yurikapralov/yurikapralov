<%@ Page Title="" Language="C#" MasterPageFile="~/En/MasterPageEng.master" AutoEventWireup="true" CodeFile="_EditProfile_old.aspx.cs" Inherits="En_EditProfile_old" Theme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceMainHolder" Runat="Server">
 <h2 style="text-align:left;">
                ...
                <tr class="tablebody">
                    <td colspan="2">
                        ...
                        <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword"
                            Text="Change Password" ValidationGroup="ChangePassword" CssClass="orderbutton" />
    ...
    <asp:Button runat="server" ID="btnUpdate" ValidationGroup="EditProfile" Text="Update Your Profile."
        OnClick="btnUpdate_Click" CssClass="orderbutton" />
</asp:Content>
